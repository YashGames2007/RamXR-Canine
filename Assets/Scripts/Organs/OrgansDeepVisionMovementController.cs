...
public class OrgansDeepVisionMovementController : MonoBehaviour
{
    private DeepVisionMovementSequence sequence;
    ...
    public static OrgansDeepVisionMovementController Instance { get; private set; }
    ...
    public void SetSequence(DeepVisionMovementSequence newSequence)
    {
